  ...
  "node_modules/tinycolor2/tinycolor.js"(exports2, module2) {
    (function(Math2) {
      ...
      function hsvToRgb(h3, s3, v3) {
        ...
        s3 = bound01(s3, 100);
        v3 = bound01(v3, 100);
        var i3 = Math2.floor(h3), f3 = h3 - i3, p3 = v3 * (1 - s3), q2 = v3 * (1 - f3 * s3), t3 = v3 * (1 - (1 - f3) * s3), mod = i3 % 6, r3 = [v3, q2, p3, p3, t3, v3][mod], g3 = [t3, v3, v3, q2, p3, p3][mod], b3 = [p3, p3, t3, v3, v3, q2][mod];
        return { r: r3 * 255, g: g3 * 255, b: b3 * 255 };
      }
      ...
      function monochromatic(color, results) {
        ...
        while (results--) {
          ret.push(tinycolor2({ h: h3, s: s3, v: v3 }));
      ...
      tinycolor2.mostReadable = function(baseColor, colorList, args) {
        ...
        for (var i3 = 0; i3 < colorList.length; i3++) {
          readability = tinycolor2.readability(baseColor, colorList[i3]);
          if (readability > bestScore) {
            bestScore = readability;
            bestColor = tinycolor2(colorList[i3]);
          }
        }
      ...
      var hexNames = tinycolor2.hexNames = flip3(names);
      function flip3(o3) {
        var flipped = {};
        for (var i3 in o3) {
      ...
      function bound01(n3, max3) {
        ...
        n3 = mathMin(max3, mathMax(0, parseFloat(n3)));
        if (processPercent) {
          n3 = parseInt(n3 * max3, 10) / 100;
        }
        if (Math2.abs(n3 - max3) < 1e-6) {
          return 1;
        }
    ...
    GradientParser.stringify = function() {
      var visitor = {
        ...
        "visit_shape": function(node) {
          var result2 = node.value, at3 = visitor.visit(node.at), style = visitor.visit(node.style);
          if (style) {
            result2 += " " + style;
          }
          if (at3) {
        ...
        "visit_default-radial": function(node) {
          var result2 = "", at3 = visitor.visit(node.at);
          if (at3) {
            result2 += at3;
          }
          return result2;
        ...
        "visit_extent-keyword": function(node) {
          var result2 = node.value, at3 = visitor.visit(node.at);
          if (at3) {
            result2 += " at " + at3;
          }
          return result2;
...
function k(e2, t3 = "custom validation failed") {
...
var M = (() => {
  ...
  return t3 = e2 = class {
    ...
    static extend(e3) {
      ...
      const { name: t4, validate: n3 = false, getter: i3 = false } = e3, o3 = r(e3, J);
      if (p(this, t4))
        throw new TypeError(`[VueTypes error]: Type "${t4}" already defined`);
      const { type: a3 } = o3;
      if (b(a3))
        return delete o3.type, Object.defineProperty(this, t4, i3 ? { get: () => T(t4, a3, o3) } : { value(...e4) {
          const r3 = T(t4, a3, o3);
      ...
      return s3 = i3 ? { get() {
        ...
        return n3 ? _(t4, e4) : j(t4, e4);
      }, enumerable: true } : { value(...e4) {
        const r3 = Object.assign({}, o3);
        let i4;
        return i4 = n3 ? _(t4, r3) : j(t4, r3), r3.validator && (i4.validator = r3.validator.bind(i4, ...e4)), i4;
      }, enumerable: true }, Object.defineProperty(this, t4, s3);
    }
  }, e2.defaults = {}, e2.sensibleDefaults = void 0, e2.config = n, e2.custom = k, e2.oneOf = D, e2.instanceOf = Y, e2.oneOfType = L, e2.arrayOf = F, e2.objectOf = B, e2.shape = I, e2.utils = { validate: (e3, t4) => true === m(t4, e3, true), toType: (e3, t4, r3 = false) => r3 ? _(e3, t4) : j(e3, t4) }, t3;
})();
function R(e2 = { func: () => {
}, bool: true, string: "", number: 0, array: () => [], object: () => ({}), integer: 0 }) {
  var r3, n3;
  return n3 = r3 = class extends M {
...
var R2 = { f: i2 ? k2 : function(t3, e2, n3) {
...
var C = r2["__core-js_shared__"] || j2("__core-js_shared__", {});
var L2 = Function.toString;
"function" != typeof C.inspectSource && (C.inspectSource = function(t3) {
  return L2.call(t3);
});
var P2;
var M2;
var _2;
var D2 = C.inspectSource;
var U = r2.WeakMap;
var N2 = "function" == typeof U && /native code/.test(D2(U));
var F2 = e(function(t3) {
  (t3.exports = function(t4, e2) {
    return C[t4] || (C[t4] = void 0 !== e2 ? e2 : {});
...
var H = r2.WeakMap;
if (N2) {
  X = C.state || (C.state = new H()), V2 = X.get, K = X.has, q2 = X.set;
  P2 = function(t3, e2) {
...
It({ target: "String", proto: true, forced: function(t3) {
  return o2(function() {
    return !!on[t3]() || "\u200B\x85\u180E" != "\u200B\x85\u180E"[t3]() || on[t3].name !== t3;
  });
}("trim") }, { trim: function() {
  return sn(this);
} });
...
Ge("replace", 2, function(t3, e2, n3, r3) {
  ...
  return [function(n4, r4) {
    ...
    for (var g3, h3 = "", y3 = 0, m3 = 0; m3 < v3.length; m3++) {
      p3 = v3[m3];
      for (var S3 = String(p3[0]), x3 = tr(er(it(p3.index), l3.length), 0), b3 = [], E3 = 1; E3 < p3.length; E3++)
        b3.push(void 0 === (g3 = p3[E3]) ? g3 : String(g3));
      var w3 = p3.groups;
      if (f3) {
...
// node_modules/vue3-colorpicker/index.es.js
import "/Users/macos/Sites/beae/node_modules/vue3-angle/style.css";
...
var Color = class {
  constructor(input) {
    ...
    __publicField(this, "initLightness", () => {
      const { s: s3, l: l3 } = this.instance.toHsl();
      this.hslSaturationValue = double(s3);
      this.lightnessValue = double(l3);
    });
    __publicField(this, "initRgb", () => {
      const { r: r3, g: g3, b: b3 } = this.instance.toRgb();
      this.redValue = double(r3);
      this.greenValue = double(g3);
      this.blueValue = double(b3);
    });
    __publicField(this, "initHsb", () => {
      const { h: h3, s: s3, v: v3 } = this.instance.toHsv();
      this.hueValue = Math.min(360, Math.ceil(h3));
      this.saturationValue = double(s3);
      this.brightnessValue = double(v3);
    });
    ...
    this.instance = (0, import_tinycolor2.default)(input);
    this.initRgb();
    this.initHsb();
    this.initLightness();
    this.initAlpha();
  ...
  set hex(hexString) {
    this.instance = (0, import_tinycolor2.default)(hexString);
    this.initHsb();
    this.initRgb();
    this.initAlpha();
    this.initLightness();
  ...
  set hue(value) {
    ...
    this.instance = (0, import_tinycolor2.default)({
      h: double(value),
      s: this.saturation,
      v: this.brightness,
  ...
  set red(value) {
    ...
    this.instance = (0, import_tinycolor2.default)(__spreadProps(__spreadValues({}, rgb), {
      r: double(value),
      a: this.alphaValue / 100
    }));
    this.initHsb();
...
function rgbaColor(r3, g3, b3, a3) {
  return `rgba(${[r3, g3, b3, a3 / 100].join(",")})`;
}
var clamp3 = (value, min3, max3) => {
  return min3 < max3 ? value < min3 ? min3 : value > max3 ? max3 : value : value < max3 ? max3 : value > min3 ? min3 : value;
};
var HistoryColorKey = "color-history";
var MAX_STORAGE_LENGTH = 8;
...
var _sfc_main$b = defineComponent({
  ...
  props: {
    ...
    size: z.oneOf(["small", "default"]).def("default")
  },
  emits: ["change"],
  setup(props, { emit }) {
...
var _withScopeId$5 = (n3) => (pushScopeId("data-v-18925ba6"), n3 = n3(), popScopeId(), n3);
var _hoisted_1$a = _withScopeId$5(() => createBaseVNode("div", { class: "vc-alpha-slider__bar-handle" }, null, -1));
var _hoisted_2$a = [
  _hoisted_1$a
];
...
var Alpha = _export_sfc(_sfc_main$b, [["render", _sfc_render$b], ["__scopeId", "data-v-18925ba6"]]);
var defaultColors = [
  [
    "#fcc02e",
    "#f67c01",
...
var _sfc_main$a = defineComponent({
  ...
  setup(_props, { emit }) {
    const computedBgStyle = (color) => {
      ...
      return { background: (0, import_tinycolor2.default)(color).toRgbString() };
    };
...
var _hoisted_1$9 = { class: "vc-compact" };
var _hoisted_2$9 = ["onClick"];
function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$9, [
    (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.palettes, (v3, i3) => {
      return openBlock(), createElementBlock("div", {
        key: i3,
        class: "vc-compact__row"
      }, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(v3, (v1, k3) => {
          return openBlock(), createElementBlock("div", {
            key: k3,
...
var Palette = _export_sfc(_sfc_main$a, [["render", _sfc_render$a], ["__scopeId", "data-v-b969fd48"]]);
var _sfc_main$9 = defineComponent({
  name: "Board",
  props: {
    color: z.instanceOf(Color),
    round: z.bool.def(false),
    hide: z.bool.def(true)
  },
  emits: ["change"],
  setup(props, { emit }) {
    var _a, _b, _c;
    ...
    const handleDrag = (event) => {
      if (instance) {
        ...
        left2 = clamp3(left2, 0, rect.width);
        top2 = clamp3(top2, 0, rect.height);
        const saturation = left2 / rect.width;
        const bright = clamp3(-(top2 / rect.height) + 1, 0, 1);
...
var _withScopeId$4 = (n3) => (pushScopeId("data-v-63803390"), n3 = n3(), popScopeId(), n3);
var _hoisted_1$8 = _withScopeId$4(() => createBaseVNode("div", { class: "vc-saturation__white" }, null, -1));
var _hoisted_2$8 = _withScopeId$4(() => createBaseVNode("div", { class: "vc-saturation__black" }, null, -1));
var _hoisted_3$6 = _withScopeId$4(() => createBaseVNode("div", null, null, -1));
var _hoisted_4$5 = [
  _hoisted_3$6
];
...
var Board = _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-63803390"]]);
var _sfc_main$8 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    watch(() => props.color, (value) => {
      if (value) {
        color = value;
        merge_default(state, { hue: color.hue });
      }
    }, { deep: true });
    const getCursorLeft = () => {
      if (barElement.value && cursorElement.value) {
...
var _withScopeId$3 = (n3) => (pushScopeId("data-v-5c4cae5b"), n3 = n3(), popScopeId(), n3);
var _hoisted_1$7 = _withScopeId$3(() => createBaseVNode("div", { class: "vc-hue-slider__bar-handle" }, null, -1));
var _hoisted_2$7 = [
  _hoisted_1$7
];
...
var Hue = _export_sfc(_sfc_main$8, [["render", _sfc_render$8], ["__scopeId", "data-v-5c4cae5b"]]);
var _sfc_main$7 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const getBackgroundStyle = computed(() => {
      const color1 = (0, import_tinycolor2.default)({
        h: state.hue,
        s: state.saturation,
        l: 0.8
      }).toPercentageRgbString();
      const color2 = (0, import_tinycolor2.default)({
        h: state.hue,
        s: state.saturation,
        l: 0.6
      }).toPercentageRgbString();
      const color3 = (0, import_tinycolor2.default)({
        h: state.hue,
        s: state.saturation,
        l: 0.4
      }).toPercentageRgbString();
      const color4 = (0, import_tinycolor2.default)({
        h: state.hue,
        s: state.saturation,
        l: 0.2
      }).toPercentageRgbString();
...
var _withScopeId$2 = (n3) => (pushScopeId("data-v-6156acb7"), n3 = n3(), popScopeId(), n3);
var _hoisted_1$6 = _withScopeId$2(() => createBaseVNode("div", { class: "vc-lightness-slider__bar-handle" }, null, -1));
var _hoisted_2$6 = [
  _hoisted_1$6
];
...
var Lightness = _export_sfc(_sfc_main$7, [["render", _sfc_render$7], ["__scopeId", "data-v-6156acb7"]]);
var _sfc_main$6 = defineComponent({
  name: "History",
  props: {
    colors: z.arrayOf(String).def(() => []),
    round: z.bool.def(false)
  },
  emits: ["change"],
  setup(_props, { emit }) {
    const onColorSelect = (v3) => {
      emit("change", v3);
    };
...
var _hoisted_2$5 = { class: "color-list" };
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.colors && _ctx.colors.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$5, [
    createBaseVNode("div", _hoisted_2$5, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.colors, (v3, i3) => {
        return openBlock(), createElementBlock("div", {
          key: i3,
          class: normalizeClass(["color-item", "transparent", { "color-item__round": _ctx.round }]),
          onClick: ($event) => _ctx.onColorSelect(v3)
        }, [
          createBaseVNode("div", {
            class: "color-item__display",
            style: normalizeStyle({ backgroundColor: v3 })
          }, null, 4)
        ], 10, _hoisted_3$5);
      }), 128))
    ])
...
var History = _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__scopeId", "data-v-7e6b67ca"]]);
var _sfc_main$5 = defineComponent({
  name: "Display",
  props: {
    color: z.instanceOf(Color),
    disableAlpha: z.bool.def(false)
  },
  ...
  setup(props, { emit }) {
    ...
    const onInputChange = (event) => {
      ...
      if ((0, import_tinycolor2.default)(hex).isValid() && state.color) {
        state.color.hex = hex;
      }
    };
    whenever(() => props.color, (value) => {
...
var _hoisted_1$4 = { class: "vc-display" };
var _hoisted_2$4 = { class: "vc-current-color vc-transparent" };
var _hoisted_3$4 = { class: "vc-color-input" };
...
var Display = _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["__scopeId", "data-v-0067da1d"]]);
var _sfc_main$4 = defineComponent({
  name: "FkColorPicker",
  components: { Display, Alpha, Palette, Board, Hue, Lightness, History },
  props: {
    color: z.instanceOf(Color),
    disableHistory: z.bool.def(false),
    roundHistory: z.bool.def(false),
    disableAlpha: z.bool.def(false)
  },
  ...
  setup(props, { emit }) {
    ...
    const updateColorHistoryFn = useDebounceFn(() => {
      ...
      historyColors.value = historyColors.value.filter((value) => {
        return !import_tinycolor2.default.equals(value, rgbString);
      });
    ...
    const onInputChange = (event) => {
      const target = event.target;
      const hex = target.value.replace("#", "");
      if ((0, import_tinycolor2.default)(hex).isValid()) {
        state.color.hex = hex;
      }
    };
    whenever(() => props.color, (value) => {
...
var _withScopeId$1 = (n3) => (pushScopeId("data-v-592a5ec3"), n3 = n3(), popScopeId(), n3);
var _hoisted_1$3 = { class: "vc-fk-colorPicker" };
var _hoisted_2$3 = { class: "vc-fk-colorPicker__inner" };
var _hoisted_3$3 = { class: "vc-fk-colorPicker__header" };
var _hoisted_4$3 = _withScopeId$1(() => createBaseVNode("div", { class: "back" }, null, -1));
var _hoisted_5$3 = [
  _hoisted_4$3
];
...
var FkColorPicker = _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-592a5ec3"]]);
...
var _hoisted_1$2 = { class: "vc-chrome-colorPicker" };
var _hoisted_2$2 = { class: "vc-chrome-colorPicker-body" };
var _hoisted_3$2 = { class: "chrome-controls" };
var _hoisted_4$2 = { class: "chrome-color-wrap transparent" };
var _hoisted_5$2 = { class: "chrome-sliders" };
...
var ChromeColorPicker = _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__scopeId", "data-v-61d7303b"]]);
var ColorPickerProviderKey = "Vue3ColorPickerProvider";
var _sfc_main$2 = defineComponent({
  name: "GradientColorPicker",
  components: { Angle, Display, Alpha, Palette, Board, Hue, Lightness, History },
  props: {
    startColor: z.instanceOf(Color).isRequired,
    endColor: z.instanceOf(Color).isRequired,
    startColorStop: z.number.def(0),
    endColorStop: z.number.def(100),
    angle: z.number.def(0),
    disableHistory: z.bool.def(false),
    roundHistory: z.bool.def(false),
    disableAlpha: z.bool.def(false)
  },
...
var _withScopeId = (n3) => (pushScopeId("data-v-f63daa7a"), n3 = n3(), popScopeId(), n3);
var _hoisted_1$1 = { class: "vc-gradient-picker" };
var _hoisted_2$1 = { class: "vc-gradient-picker__header" };
var _hoisted_3$1 = _withScopeId(() => createBaseVNode("div", { class: "back" }, null, -1));
var _hoisted_4$1 = [
  _hoisted_3$1
];
var _hoisted_5$1 = { class: "vc-gradient-picker__body" };
var _hoisted_6$1 = {
  class: "vc-color-range",
  ref: "colorRangeRef"
};
var _hoisted_7 = { class: "vc-color-range__container" };
var _hoisted_8 = { class: "vc-gradient__stop__container" };
var _hoisted_9 = ["title"];
var _hoisted_10 = _withScopeId(() => createBaseVNode("span", { class: "vc-gradient__stop--inner" }, null, -1));
var _hoisted_11 = [
  _hoisted_10
];
var _hoisted_12 = ["title"];
var _hoisted_13 = _withScopeId(() => createBaseVNode("span", { class: "vc-gradient__stop--inner" }, null, -1));
var _hoisted_14 = [
  _hoisted_13
];
var _hoisted_15 = { class: "vc-picker-degree-input vc-degree-input" };
var _hoisted_16 = { class: "vc-degree-input__control" };
var _hoisted_17 = ["value"];
var _hoisted_18 = { class: "vc-degree-input__panel" };
var _hoisted_19 = { class: "vc-degree-input__disk" };
...
var GradientColorPicker = _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__scopeId", "data-v-f63daa7a"]]);
var _sfc_main$1 = defineComponent({
  name: "WrapContainer",
  props: {
    showTab: z.bool.def(false),
    activeKey: z.oneOf(["pure", "gradient"]).def("pure")
  },
  ...
  setup(props, { emit }) {
    ...
    return { state, onActiveKeyChange, lang: parent2 == null ? void 0 : parent2.lang };
  }
});
var _hoisted_1 = { class: "vc-colorpicker" };
var _hoisted_2 = { class: "vc-colorpicker--container" };
var _hoisted_3 = {
  key: 0,
  class: "vc-colorpicker--tabs"
};
var _hoisted_4 = { class: "vc-colorpicker--tabs__inner" };
var _hoisted_5 = { class: "vc-btn__content" };
var _hoisted_6 = { class: "vc-btn__content" };
        ...
        createBaseVNode("div", _hoisted_4, [
          createBaseVNode("div", {
            ...
            createBaseVNode("button", null, [
              createBaseVNode("div", _hoisted_5, toDisplayString(_ctx.lang === "ZH-cn" ? "\u7EAF\u8272" : "Pure"), 1)
            ])
          ], 2),
          createBaseVNode("div", {
            class: normalizeClass([
            ...
            createBaseVNode("button", null, [
              createBaseVNode("div", _hoisted_6, toDisplayString(_ctx.lang === "ZH-cn" ? "\u6E10\u53D8\u8272" : "Gradient"), 1)
            ])
          ], 2),
          createBaseVNode("div", {
...
var WrapContainer = _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-4afdf3bb"]]);
var colorPickerProps = {
  isWidget: z.bool.def(false),
  pickerType: z.oneOf(["fk", "chrome"]).def("fk"),
  shape: z.oneOf(["circle", "square"]).def("square"),
  pureColor: {
    type: [String, Object],
    default: "#000000"
  },
  gradientColor: z.string.def("#000"),
  format: {
    type: String,
    default: "rgb"
  },
  ...
  disableHistory: z.bool.def(false),
  roundHistory: z.bool.def(false),
  useType: z.oneOf(["pure", "gradient", "both"]).def("pure"),
  activeKey: z.oneOf(["pure", "gradient"]).def("pure"),
  lang: {
    type: String,
    default: "ZH-cn"
  },
  zIndex: z.number.def(9999)
};
var _sfc_main = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const getBgColorStyle = computed(() => {
      const bgColor = state.activeKey !== "gradient" ? (0, import_tinycolor2.default)(state.pureColor).toRgbString() : gradientState.gradientColor;
      return {
        background: bgColor
      };
    });
    ...
    const getBindArgs = computed(() => {
      if (state.activeKey === "gradient") {
        return {
          ...
          onStartColorChange: (v3) => {
            gradientState.startColor = v3;
            onGradientChange();
          },
          onEndColorChange: (v3) => {
            gradientState.endColor = v3;
            onGradientChange();
          },
          angle: gradientState.angle,
          startColorStop: gradientState.startColorStop,
          endColorStop: gradientState.endColorStop,
          onStartColorStopChange: (v3) => {
            gradientState.startColorStop = v3;
            onGradientChange();
          },
          onEndColorStopChange: (v3) => {
            gradientState.endColorStop = v3;
            onGradientChange();
          },
          onAngleChange: (v3) => {
            gradientState.angle = v3;
            onGradientChange();
          },
          onAdvanceChange: (v3) => {
            state.isAdvanceMode = v3;
          }
        };
      }
      return {
    ...
    const parseGradientColor = () => {
      var _a, _b, _c, _d;
      try {
        const [colorNode] = (0, import_gradient_parser.parse)(gradientState.gradientColor);
        if (colorNode && colorNode.type === "linear-gradient" && ((_a = colorNode.orientation) == null ? void 0 : _a.type) === "angular" && colorNode.colorStops.length >= 2) {
          ...
          const [r3, g3, b3, a3] = startColorVal.value;
    ...
    const onGradientChange = () => {
      ...
      try {
        gradientState.gradientColor = (0, import_gradient_parser.stringify)(nodes);
    ...
    const color2GradientNode = () => {
      const nodes = [];
      const startColorArr = gradientState.startColor.RGB.map((v3) => v3.toString());
      const endColorArr = gradientState.endColor.RGB.map((v3) => v3.toString());
      nodes.push({
    ...
    const onInit = () => {
      if (colorCubeRef.value && pickerRef.value) {
        createPopper3(colorCubeRef.value, pickerRef.value, {
          placement: "auto",
          modifiers: [
            {
              name: "flip",
    ...
    const onColorChange = (v3) => {
      colorInstance.value = v3;
      state.pureColor = v3.toString(props.format);
      emitColorChange();
    };
    ...
    whenever(() => props.pureColor, (value) => {
      const equal = import_tinycolor2.default.equals(value, state.pureColor);
      if (!equal) {
...
var ColorPicker = _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-0aa3a75d"]]);
var Vue3ColorPicker = {
  install: (app) => {
...
// dep:vue3-colorpicker
var vue3_colorpicker_default = Vue3ColorPicker;
export {
  ColorPicker,
  vue3_colorpicker_default as default
};
/*!
